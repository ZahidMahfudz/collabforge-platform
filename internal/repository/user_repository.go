...
func (r *UserRepository) FindByID(ctx context.Context, id string) (*entity.User, error){
	query := `SELECT id, first_name, last_name, mid_name, username, email, password_hash, provider, provider_id, bio, avatar_url, created_at, updated_at FROM users WHERE id=$1`
